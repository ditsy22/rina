<div class="gap no-gap">
    <div class="inner-bg">
        <div class="element-title">
            ...
            <form action="<?= base_url('admin/keluartambah') ?>" method="post" enctype="multipart/form-data">

                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Tanggal Keluar</label>
                            <input class="form-control" name="tanggalkeluar" type="date" required value="<?= date('Y-m-d') ?>" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" id="harga1" name="harga[]" oninput="check()" onchange="check()" class="form-control harga" value="0" readonly required>
                            </div>
                        </td>
                        <td width="15%">
                            <div class="form-group">

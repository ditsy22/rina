    ...
    <div class="element-title">
        <div class="table-styles">
            <?php if ($this->session->userdata('level') == 'Admin') { ?>
                <a href="<?php echo base_url(); ?>admin/masuktambah" class="btn-st grn-clr"><i class="fa fa-plus"></i> Tambah Masuk</a>
            <?php } ?>
            <div class="widget">
                <table class="prj-tbl striped bordered table-responsive" id="tabel">
                    <thead>
                        <tr>
                            <th><em>No</em></th>
                            <th><em>Nama Supplier</em></th>
                            <th><em>Tanggal Masuk</em></th>
                    ...
                    <tbody>
                        <?php $i = 1;
                        $grandtotal = 0;
                        foreach ($masuk as $pro) : ?>
                            <tr>
                                <td><?php echo $i . '.'; ?></td>
                                <td><span><?php echo $pro['nama']; ?></span></td>
                                <td><i><?php echo date('d-m-Y', strtotime($pro['tanggalmasuk'])); ?></i></td>
                                ...
                                <?php if ($this->session->userdata('level') == 'Admin') { ?>
                                    <td>
                                        <a href="<?php echo base_url(); ?>admin/masukhapus/<?php echo $pro['kodemasuk']; ?>" class="btn-st rd-clr bdel">Hapus</a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Daftar Masuk Barang</h5>
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-striped" id="table2">
                        ...
                        <tbody>
                            ...
                            $nobelanja = 1;
                            $pengeluaran = 0;
                            $daftarbarang = $this->Admin_model->getresult(array('kodemasuk' => $pro['kodemasuk']), 'tb_masuk');
